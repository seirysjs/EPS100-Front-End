<template>
  <div class="container">
        ...
        <td>
          <div class="field is-grouped">
            <div class="control">
              ...
              <input
                class="input"
                :class="errors.order_id && 'is-danger'"
                type="number"
            ...
            <div class="control">
              ...
              <div
                ...
                :class="errors.client_id && 'is-danger'"
              >
                <select
                  ...
                  <div class="column">
                    ...
                    <div class="control">
                      <input
                        class="input"
                        :disabled="status == 'done'"
                        :class="errors.address && 'is-danger'"
                        style="width: 180px"
                        type="text"
                  ...
                  <div class="column">
                    ...
                    <div class="control">
                      <input
                        class="input"
                        :disabled="status == 'done'"
                        :class="errors.postal_code && 'is-danger'"
                        style="width: 180px"
                        type="text"
                  ...
                  <div class="column">
                    ...
                    <div class="control">
                      <input
                        class="input"
                        :disabled="status == 'done'"
                        :class="errors.country && 'is-danger'"
                        style="width: 180px"
                        type="text"
                  ...
                  <div class="column">
                    ...
                    <div class="control">
                      <input
                        class="input"
                        :disabled="status == 'done'"
                        :class="errors.laddress && 'is-danger'"
                        style="width: 180px"
                        type="text"
                        v-model="form.laddress"
                  ...
                  <div class="column">
                    ...
                    <div class="control">
                      <input
                        class="input"
                        :disabled="status == 'done'"
                        :class="errors.lpostal_code && 'is-danger'"
                        style="width: 180px"
                        type="text"
                        v-model="form.lpostal_code"
                  ...
                  <div class="column">
                    ...
                    <div class="control">
                      <input
                        class="input"
                        :disabled="status == 'done'"
                        :class="errors.lcountry && 'is-danger'"
                        style="width: 180px"
                        type="text"
                        v-model="form.lcountry"
                        placeholder="Lietuva"
                      />
                    </div>
                  </div>
      ...
      <tr>
        <td>
          <table class="table is-fullwidth">
            ...
            <tbody>
              <tr
                v-for="(productRow, index) in fulfilledProductRows"
                v-bind:key="index"
              >
                <td>
                  <div
    ...
    <div class="field is-grouped is-grouped-left">
      <div class="control">
        <a href="#" class="button is-light" @click="routerGoBack()">Grįžti</a>
      </div>
  ...
  methods: {
    addProductRow(orderItem, fulfilled) {
      ...
      fetchBlueprintsByClass(productRow.product_class_id).then((res) => {
        ...
        fetchBlueprint(productRow.blueprint_id).then((res) => {
          ...
          if (!fulfilled) this.productRows.push(productRow);
          if (fulfilled) this.fulfilledProductRows.push(productRow);
          if (
            this.productRows.length >= this.form.order_items.length &&
            this.fulfilledProductRows.length >=
              this.form.order_item_fulfills.length
          )
            this.done = true;
          this.getTotalVolume();
        });
    ...
    load() {
      ...
      fetchOrder(this.id).then((res) => {
        ...
        if (this.form.order_items.length == 0 && this.status != "done")
          this.addProductRow();
        this.form.order_items.forEach((orderItem) =>
          this.addProductRow(orderItem)
        );
        this.form.order_item_fulfills.forEach((orderItem) =>
          this.addProductRow(orderItem, true)
        );
        if (
          this.form.order_items.length == 0 &&
          this.form.order_item_fulfills.length == 0 &&
          this.status == "done"
        )
          this.done = true;
      });
    ...
    getTotalVolume() {
      ...
      for (
        ...
        productRowIndex < this.fulfilledProductRows.length;
        productRowIndex++
      ) {
