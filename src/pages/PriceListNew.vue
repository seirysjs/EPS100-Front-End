  ...
  methods: {
    load() {
      fetchProductClasses().then((res) => {
        ...
        for (
          ...
          indexProductClass < this.product_classes.length;
          indexProductClass++
        ) {
          const productClass = this.product_classes[indexProductClass];

          this.addProductClassPriceRow({
            product_class_id: productClass.product_class_id,
          });
        }
      });
    ...
    addProductClassPriceRow(productClassPrice) {
      ...
      productClassRow.product_class_id = productClassPrice.product_class_id
        ...
        : 0;
      productClassRow.amountCostBlock = productClassPrice.amountCostBlock
        ? productClassPrice.amountCostBlock
        : 0;
      productClassRow.amountCost = productClassPrice.amountCost
        ? productClassPrice.amountCost
        : 0;
      productClassRow.markup = productClassPrice.markup
        ? productClassPrice.markup
        : 20;
      productClassRow.amountProduct = productClassPrice.amountProduct
        ? productClassPrice.amountProduct
        : 0;
      productClassRow.amountProductBlock = productClassPrice.amountProductBlock
        ? productClassPrice.amountProductBlock
        : 0;
