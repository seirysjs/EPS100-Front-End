<template>
  <div class="container">
    <div class="block">
      <h1 class="is-size-3">
        Produktai ({{ product_class.name }} - {{ product_class.days_to_dry }}D)
      </h1>
    </div>
          ...
          >
            ...
            <template #body>
              <tr v-for="(blueprint, index) in data" v-bind:key="index">
                ...
                <td>
                  <div class="tag">{{ blueprint.product_class.name }}</div>
                </td>
                <td>
                  &nbsp;
                  <div class="tag">{{ blueprint.product_size.x_mm }}</div>
                  &nbsp;x&nbsp;
                  <div class="tag">{{ blueprint.product_size.y_mm }}</div>
                  &nbsp;x&nbsp;
      ...
      <tab name="Blokai">
        <div class="block">
          ...
          <data-table
            :rowsPerPage="5"
            :list="blocksQueue"
            @dataSlice="(data) => (this.dataQueue = data)"
          >
            <template #head>
              <tr>
                <th>Bloko Nr.</th>
        ...
        <div class="block">
          ...
          <data-table
            :rowsPerPage="5"
            :list="blocksDrying"
            @dataSlice="(data) => (this.dataDrying = data)"
          >
            <template #head>
              <tr>
                <th>Bloko Nr.</th>
