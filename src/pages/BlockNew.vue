    ...
    <div style="width: 380px">
      <div class="field is-grouped is-grouped-left">
        <div class="control">
          ...
          <input
            class="input"
            :class="errors.block_id && 'is-danger'"
            type="number"
            v-model="form.block_id"
            :placeholder="blockQueueId"
          />
        </div>
        <div class="control">
      ...
      <div class="field">
        ...
        <div class="control">
          <input
            class="input"
            :class="errors.drying_started_at && 'is-danger'"
            @change="onDryingChange()"
            type="datetime-local"
            v-model="form.drying_started_at"
          />
        </div>
      </div>
      <div class="field">
        ...
        <div class="control">
          <input
            class="input"
            :class="errors.drying_ends_at && 'is-danger'"
            type="datetime-local"
            v-model="form.drying_ends_at"
          />
        </div>
      </div>
      <div class="field">
  ...
  methods: {
    ...
    onDryingChange() {
      ...
      fetchProductClass(this.form.product_class_id).then((res) => {
        ...
        const newDryingEndDate = dateToLocaleString(
          new Date(this.form.drying_started_at).getTime() +
            days_to_dry * 86400000
        );
