<template>
  <div class="container">
    <h1 class="is-size-3">
      Blokas Nr. {{ block.block_id ? block.block_id : "" }}
    </h1>
    <br />
    <div class="block has-background-light p-5">
      <div class="field is-grouped is-grouped-left">
        <div class="control">
          <router-link :to="{ name: 'blockList' }" class="button is-light"
            >Grįžti</router-link
          >
        </div>
        <div class="control">
          <router-link
            :to="{
              name: 'blockEdit',
              params: { id: block.block_id ? block.block_id : 0 },
            }"
          ...
          <table class="table">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="tag">
                    {{ block.product_class ? block.product_class.name : "" }}
                  </div>
                </td>
              </tr>
              <tr>
