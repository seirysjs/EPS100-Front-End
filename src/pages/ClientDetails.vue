    ...
    <div class="block">
      ...
      <div class="block has-background-light p-5">
        <div class="field is-grouped is-grouped-left">
          <div class="control">
            <router-link :to="{ name: 'clientList' }" class="button is-light"
              >Grįžti</router-link
            >
          </div>
          <div class="control">
        ...
        >
          <tab name="Vykdomi">
            <div v-if="ordersInWIP.length != 0">
              ...
              <data-table
                :rowsPerPage="10"
                :list="ordersInWIP"
                @dataSlice="(data) => (this['data' + 'Wip'] = data)"
              >
                <template #head>
                  <tr>
                    <th>Užsakymo Nr.</th>
          ...
          <tab name="Eilėje">
            <div v-if="ordersInQueue.length != 0">
              ...
              <data-table
                :rowsPerPage="10"
                :list="ordersInQueue"
                @dataSlice="(data) => (this['data' + 'Queue'] = data)"
              >
                <template #head>
                  <tr>
                    <th>Užsakymo Nr.</th>
          ...
          <tab name="Visi">
            ...
            <data-table
              :rowsPerPage="10"
              :list="ordersAll"
              @dataSlice="(data) => (this['data' + 'All'] = data)"
            >
              <template #head>
                <tr>
                  <th>Užsakymo Nr.</th>
          ...
          >
            <template #head>
              <tr>
                ...
                <th>
                  <label>Mokėjimų likutis<br />(Eur)</label>
                </th>
...
import {
  fetchBillsByClient,
  fetchClient,
  fetchOrdersByClientOpen,
  fetchOrdersByClientWIP,
} from "@/lib/api";
import {
  totalAmountPayments,
  roundNumberScaleTwo,
