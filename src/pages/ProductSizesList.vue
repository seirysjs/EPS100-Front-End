  ...
  <div class="container">
    ...
    <div class="block has-background-light p-5">
      <div class="field is-grouped is-grouped-left">
        <div class="control">
          <router-link :to="{ name: 'productList' }" class="button is-light"
            >Grįžti</router-link
          >
        </div>
        <div class="control">
      ...
      >
        ...
        <template #body>
          <tr v-for="(productSizes, index) in data" v-bind:key="index">
            <td>
              <div class="tag">{{ productSizes.x_mm }}</div>
            </td>
            <td>
              <div class="tag">{{ productSizes.y_mm }}</div>
            </td>
            <td>
              <div class="tag">{{ productSizes.z_mm }}</div>
            </td>
            <td>
              <div class="tag">{{ productSizes.blueprints.length }}</div>
            </td>
            <td>
              <div class="control">
                <router-link
