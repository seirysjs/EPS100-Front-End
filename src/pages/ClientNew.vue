...
<tr>
  ...
  <div class="column">
    ...
    <div class="control">
      <input class="input" :class="errors.name && 'is-danger'" style="width: 180px;" type="text" v-model="form.name">
    </div>
  </div>
  <div class="column">
    <label class="label" for="phone">El. Paštas:</label>
    <div class="control">
      <input class="input" :class="errors.email && 'is-danger'" style="width: 180px;" type="text" v-model="form.email">
    </div>
  </div>
  <div class="column">
