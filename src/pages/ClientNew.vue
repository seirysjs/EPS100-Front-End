<template>
  <div class="container">
    <h1 class="is-size-3">Naujo kliento forma</h1>
                  ...
                  <div class="field is-grouped">
                    <div class="column">
                      ...
                      <div class="control">
                        <input
                          class="input"
                          :class="errors.company_code && 'is-danger'"
                          style="width: 180px"
                          type="text"
                    ...
                    <div class="column">
                      <label class="label" for="city"
                        >PVM mokėtojo kodas:</label
                      >
                      <div class="control">
                        <input
                          class="input"
                          :class="errors.vat_code && 'is-danger'"
                          style="width: 180px"
                          type="text"
                    ...
                    <div class="column">
                      ...
                      <div class="control">
                        <input
                          class="input"
                          :class="errors.banks_name && 'is-danger'"
                          style="width: 180px"
                          type="text"
                          v-model="form.banks_name"
                        />
                      </div>
                    </div>
                    <div class="column">
                      <label class="label" for="city"
                        >Banko sąskaitos Nr:</label
                      >
                      <div class="control">
                        <input
                          class="input"
                          :class="errors.account_number && 'is-danger'"
                          style="width: 180px"
                          type="text"
